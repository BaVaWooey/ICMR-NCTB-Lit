...
class VerbalMemoryTrialThird extends StatefulWidget {
  const VerbalMemoryTrialThird({super.key});

  @override
  State<VerbalMemoryTrialThird> createState() => _VerbalMemoryTrialThirdState();
}

class _VerbalMemoryTrialThirdState extends State<VerbalMemoryTrialThird> {
  ...
  void startRecording() async {
    ...
    var trial1Directory =
        await Directory('$path/verbal_memory/trial_3').create(recursive: true);
  ...
  void stateWords() async {
    ...
    while (count < 10) {
      audioWord = wordToAudio[allRecitals[2][count]]!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: const Text("Trial 3", style: TextStyle(fontSize: 40)),
            toolbarHeight: 100,
            centerTitle: true),
        body: startTimer > 0
            ? Center(
