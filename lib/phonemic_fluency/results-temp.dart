          ...
          child: FloatingActionButton.extended(
              ...
              onPressed: () => {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => currentElement == 'm'
                              ? const PhonemicFluencyKa()
                              : (currentElement == 'k'
                                  ? const PhonemicFluencyPa()
                                  : const PhonemicFluencyReport()),
                        ))
                  }),
        ));
  }
