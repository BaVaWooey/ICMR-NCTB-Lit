...
class _FASTRiverComprehensionState extends State<FASTRiverComprehension> {
  ...
  List<double> temp_list_first = [], temp_temp_list_second = [];
  List<List<double>> first_inputs = [], temp_list_second = [];
  List<List<List<double>>> second_inputs = [];
  ...
  void addingInstructionTime() async {
    while (true) {
                                            ...
                                            onPressed: () => {
                                                  ...
                                                  if (instructionStating ==
                                                      ...
                                                      replays_total > 0)
                                                    {
                                                      ...
                                                      ///here we give them the opportunity to state the instruction
                                                      setState(() {
                                                        debugPrint(
                                                            '$instructionNumber $replays_total');
