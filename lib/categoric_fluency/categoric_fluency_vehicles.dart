...
class _CategoricFluencyVehicleState extends State<CategoricFluencyVehicle> {
  ...
  void changeTimerValue() async {
    if (categoricFluencyRecordingInProgress == true ||
        categoricFluencyVehicleComplete == true) {
      return;
    }
    while (timerValue > 0) {
  ...
  void recordAndPost() async {
    ...
    var newDirectory = await Directory('$path/vehicle').create(recursive: true);
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Row(mainAxisSize: MainAxisSize.min, children: [
            Text('Categoric Fluency Vehicle', style: TextStyle(fontSize: 40)),
            Icon(Icons.directions_car_sharp, size: 50, color: Colors.black)
          ]),
          centerTitle: true,
          toolbarHeight: 100),
      ...
      body: Column(children: [
        ...
        Padding(
            ...
            child: MaterialButton(
                ...
                color: Colors.blue,
                child: categoricFluencyVehicleComplete == false
                    ? SizedBox(
                        height: 60,
                        width: 60,
        ...
        Padding(
            ...
            child: categoricFluencyVehicleComplete == false
                ...
                : Text(categoricFluencyCompletedVehicle,
                    style: const TextStyle(
                        fontSize: 30,
                        height: 1.5))) // add variable property here
      ]),
      floatingActionButton: Visibility(
          visible: categoricFluencyVehicleComplete &&
